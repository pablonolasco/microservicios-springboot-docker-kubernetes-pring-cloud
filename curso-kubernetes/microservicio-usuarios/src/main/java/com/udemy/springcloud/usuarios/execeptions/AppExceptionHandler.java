...
import com.udemy.springcloud.usuarios.util.ErrorsMessageResponse;
import com.udemy.springcloud.usuarios.util.ValidacionErrores;
...
public class AppExceptionHandler {
	...
	public ResponseEntity<ErrorsMessageResponse>manejadorResourceNotFoundException(Exception exception,WebRequest webRequest){
		ErrorsMessageResponse errorDetalles= new ErrorsMessageResponse(new Date(),exception.getMessage(),webRequest.getDescription(false),HttpStatus.INTERNAL_SERVER_ERROR.value());
	...
	public ResponseEntity<ErrorsMessageResponse>manejadorResourceNotFoundException(ResourceNotFoundException exception,WebRequest webRequest){
		ErrorsMessageResponse errorDetalles= new ErrorsMessageResponse(new Date(),exception.getMessage(),webRequest.getDescription(false),HttpStatus.NOT_FOUND.value());
	...
	public ResponseEntity<ErrorsMessageResponse>manejadorResourceNotFoundException(BadRequestException exception,WebRequest webRequest){
		ErrorsMessageResponse errorDetalles= new ErrorsMessageResponse(new Date(),exception.getMessage(),webRequest.getDescription(false),HttpStatus.BAD_REQUEST.value());
